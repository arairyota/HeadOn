...
BYTE				InputKeyboard::mKeyState[NUM_KEY_MAX];
BYTE				InputKeyboard::mKeyStateTrigger[NUM_KEY_MAX];
BYTE				InputKeyboard::mKeyStateRelease[NUM_KEY_MAX];
BYTE				InputKeyboard::mKeyStateRepeat[NUM_KEY_MAX];
int					InputKeyboard::mKeyStateRepeatCnt[NUM_KEY_MAX];
DIMOUSESTATE2		InputMouse::mMouseState;
DIMOUSESTATE2		InputMouse::mMouseStateTrigger;
DIMOUSESTATE2		InputMouse::mMouseStateRelease;
POINT				InputMouse::mPosMouse;
bool				InputMouse::mFixing;
...
InputKeyboard * InputKeyboard::create(HINSTANCE hInstance, HWND hWnd)
{
	auto key = new InputKeyboard;
...
InputMouse * InputMouse::create(HINSTANCE hInstance, HWND hWnd)
{
	auto mouse = new InputMouse;
...
//////////////////////////////////////////////////////////////////////////////
//関数名	: InputMouse::getScreenPos
//返り値	: 
//説明		: マウスのウィンドウ座標
//////////////////////////////////////////////////////////////////////////////
POINT InputMouse::getScreenPos(void)
{
	auto pos = mPosMouse;
	ScreenToClient(GetFocus(), &pos);
	return pos;
...
//////////////////////////////////////////////////////////////////////////////
//関数名	: InputMouse::setPos
//返り値	: 
//説明		: マウスを指定位置に移動
//////////////////////////////////////////////////////////////////////////////
void InputMouse::setPos(POINT pos)
{
	SetCursorPos(pos.x, pos.y);
}

//////////////////////////////////////////////////////////////////////////////
//関数名	: InputMouse::setScreenPos
//返り値	: 
//説明		: マウスを指定位置に移動(スクリーン座標)
//////////////////////////////////////////////////////////////////////////////
void InputMouse::setScreenPos(POINT pos)
{
	WINDOWINFO info;
	GetWindowInfo(GetFocus(), &info);

	SetCursorPos(info.rcClient.left + pos.x, info.rcClient.top + pos.y);
}
